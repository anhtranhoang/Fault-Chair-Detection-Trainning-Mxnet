...
train_dataset = COCOInstance(root='F:/HoangAnh/ScanComProject/Images/dataTrainBaseline/Lateral/dataTrain-27-5/trainFormatCoco/',
                                splits='train', skip_empty=True)
# and val2014 (i.e. minival5k) test as validation data
val_dataset = COCOInstance(root='F:/HoangAnh/ScanComProject/Images/dataTrainBaseline/Lateral/dataTrain-27-5/trainFormatCoco/valid',
                                splits='valid', skip_empty=False)
...
net = model_zoo.get_model('mask_rcnn_resnet18_v1b_coco', pretrained_base=False)
print(net)
